 ...
 * Board identifier.
 */
#define BOARD_GEREFI_WIDEBAND_REV2
/*
 * Board identifier.
 */
#define BOARD_NAME                  "gerEfi Wideband Controller rev 3"
 ...
 * Port C setup.
 * PC0..PC8 - unused
 * PC9  - LED_BLUE                  (output pushpull, 2 MHz).
 * PC10 - Input_3                   (digital input, no pull)
 * PC11 - Input_4                   (digital input, no pull)
 * PC12 - Input_1                   (digital input, no pull)
 ...
 * PD0, PD1 - Crystal
 * PD2 - Input_2                   (digital input, no pull)
 */
