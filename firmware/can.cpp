...
// this same header is imported by gerEFI to get struct layouts and firmware version
...
void SendGerefiFormat(uint8_t ch)
{
...

    {
        ...
        frame.get().Version = GEREFI_WIDEBAND_VERSION;
